...
const Header = ({ level }) => {
  return (
    ...
    React.createElement("span", {
      className: `title title-${level}` }, "THE GRID"), " - Roguelike")));
...
const Score = ({ iconClass, title, value }) => {
  return (
    ...
    React.createElement("span", { className: "score-label" }, `${title}: ${value}`)));
...
class Tips extends Component {
  ...
  render() {
    return (
      React.createElement("div", { className: "strip" },
      React.createElement("p", null, " Tip: ", this.state.tips[this.state.displayIdx])));
...
const Messages_ = ({ messages }) => {
  return (
    React.createElement("div", { className: "panel messages" },
...
class PlayerSettings_ extends Component {
  ...
  render() {
    ...
    return (
      ...
      React.createElement("label", { htmlFor: "toggle" }, "Toggle fog mode")),



      React.createElement("div", { className: "score-item" },
      React.createElement("div", { onClick: restartGame, className: "restart-btn" }),
      React.createElement("span", { onClick: restartGame, className: "setting-label" }, "Restart"))));
...
const ScoreBoard = ({ grid, player }) => {
  return (
    React.createElement("div", { className: "panel scoreboard" },
...
ReactDOM.render(
React.createElement(Provider, { store: createStoreWithMiddleware(enableBatching(reducers)) },
